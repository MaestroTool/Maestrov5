...
echo $red"            harap sabar menunggu yaa anjing :v("   
sleep 1
...
echo " "
echo "🔰"$cy"["$me"MENU"$cy"]"$me"🔰"
sleep 1
echo "⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩⏩ ⏩⏩⏩⏩⏩⏩⏩⏩"
echo $i"["$me"1"$i"]"$bi"🔀🔀|DarkFB v1.6"$me"                    [M]"
sleep 2
echo $i"["$me"2"$i"]"$bi"🔀🔀|DarkFB Peremuim"$me"                [A]"
sleep 0.2
...
sleep 0.1
echo $i"["$me"9"$i"]"$bi"🔀🔀|PROFILEGUARD FB"$me"		  [O]"
sleep 0.1
